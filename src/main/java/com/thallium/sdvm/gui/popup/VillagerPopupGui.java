...
public class VillagerPopupGui extends SyncedGuiDescription
{
    private static final Identifier question_panel = new Identifier("sdvm", "textures/gui/question_panel.png");

    public VillagerPopupGui(int syncId, PlayerInventory inventory, ScreenHandlerContext empty, PlayerEntity player)
    {
