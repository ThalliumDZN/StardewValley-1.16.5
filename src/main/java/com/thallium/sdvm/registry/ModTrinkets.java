...
public class ModTrinkets
{
    ...
    public static final RingMaterial glowRing = new GlowRing("glow_ring", "tooltip.sdvm.ruby_ring");
    ...
    public static void registerTrinkets() {
        ...
        Registry.register(Registry.ITEM, new Identifier(StardewValley.Mod_ID, "glow_ring"), glowRing);
